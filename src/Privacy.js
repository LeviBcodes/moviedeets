...
const Privacy = () => {
    ...
    return (
        <>
         ...
         {showPrivacy &&
            <div id="privacy" className="z-10 h-screen mx-auto box-border fixed bottom-0 opacity-95 top-0 left-0 right-0 bg-black rounded-md transition-all ease-linear duration-400 text-black" onClick={()=> setShowPrivacy(false)}>
                <div className="sm:pt-40 opacity-100">
                    <div className="bg-white rounded-lg mx-auto container px-5 py-5 opacity-100 z-20">
                        <div className="flex justify-between rounded-t border-b pb-2 opacity-100">
                            <h3 className="text-xl font-semibold text-gray-900">
                                Privacy Policy
                            </h3>
                            <button type="button" className="text-gray-400 hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="defaultModal">
